...
void m19::frame_size_calculator::do_mem_alloc_node(m19::mem_alloc_node * const node, int lvl) {
  // EMPTY
}
...
void m19::frame_size_calculator::do_section_conditional_node(m19::section_conditional_node *const node, int lvl) {
  node->block()->accept(this, lvl + 2);
}

void m19::frame_size_calculator::do_section_final_node(m19::section_final_node *const node, int lvl) {
  node->block()->accept(this, lvl + 2);
}

void m19::frame_size_calculator::do_section_initial_node(m19::section_initial_node *const node, int lvl) {
  node->block()->accept(this, lvl + 2);
}
